...
public class ProductController implements Initializable {
    ...
    @FXML
    private TextField searchStrength;
    @FXML
    private TextField searchMinStock;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        type.getItems().addAll("ml", "mg", "g", "");
        searchType.getItems().addAll("ml", "mg", "g", "");
        refreshProducts();
    }
    ...
    public void clearSearch() {
        ...
        if (!searchBrand.isFocused()) {
            searchBrand.clear();
        }
        if (!searchStrength.isFocused()) {
            searchStrength.clear();
        }
        if (!searchType.isFocused()) {
            searchType.getSelectionModel().clearSelection();
        }
        if (!searchMinStock.isFocused()) {
            searchMinStock.clear();
        }
        if (!searchDescription.isFocused()) {
